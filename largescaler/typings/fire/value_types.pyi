...
"""Types of values."""
VALUE_TYPES = ...
def IsGroup(component): # -> bool:
  ...

def IsCommand(component): # -> TypeIs[FunctionType | MethodType | BuiltinFunctionType | WrapperDescriptorType | MethodDescriptorType | ClassMethodDescriptorType] | TypeIs[type[Any]]:
  ...

def IsValue(component): # -> bool:
  ...

def IsSimpleGroup(component): # -> bool:
...
def HasCustomStr(component): # -> bool:
